...
Route::get('work-place/control-panel/back-office', [AdminController::class, 'admin_dashboard'])->name('admin.dashboard')->middleware(['auth', 'admin', 'prevent-back-history']);
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        // Steadfast Courier API Routes
        
        Route::post('/orders/{order}/send-to-steaddfast', [OrderController::class, 'sendToSteadfast'])
            ->name('orders.send_to_steadfast');

        
    
        Route::post('/orders/manual-create-steadfast', [OrderController::class, 'manualCreateSteadfastOrder'])
            ->name('orders.manual_create_steadfast');
    });
    ...
    Route::get('lottary', [AdminLottaryController::class, 'index'])->name('admin.lottary.index');
    Route::get('lottary/create', [AdminLottaryController::class, 'create'])->name('admin.lottary.create');
    Route::post('lottary/store', [AdminLottaryController::class, 'store'])->name('admin.lottary.store');
    Route::get('lottary/edit/{id}', [AdminLottaryController::class, 'edit'])->name('admin.lottary.edit');
    Route::put('lottary/update/{id}', [AdminLottaryController::class, 'update'])->name('admin.lottary.update');
    Route::get('lottary/delete/{id}', [AdminLottaryController::class, 'delete'])->name('admin.lottary.delete');
    Route::get('lottary/{id}/prizes', [AdminLottaryController::class, 'getPrizes'])->name('admin.lottary.prizes');
    Route::get('lottary/{id}/tickets', [AdminLottaryController::class, 'viewTicketsByLottary'])->name('admin.lottary.tickets');
    Route::get('lottary/drew', [AdminLottaryController::class, 'drew'])->name('admin.lottary.drew');
    Route::get('lottery/{id}/winners', [AdminLottaryController::class, 'getWinner'])->name('user.lottary.winners');
    Route::get('lottery/claim-prize-requests', [AdminLottaryController::class, 'claimPrizeRequest'])->name('admin.lottary.claim.request');
    Route::get('lottery/claim-details/{id}', [AdminLottaryController::class, 'viewClaimDetails'])->name('admin.lottary.claim.details');
    Route::put('lottery/send-gift', [AdminLottaryController::class, 'sendGift'])->name('admin.lottary.sendgift');
    
    // Stead Fast 
    
    Route::get('/steadfast', [SteadfastKeyController::class, 'index'])->name('steadfast.index');
    Route::put('/steadfast/update', [SteadfastKeyController::class, 'update'])->name('steadfast.update');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    Route::get('/my-lottaries', [UserLottaryController::class, 'index'])->name('user.lottary.index');

    Route::get('/my-lottaries/tickets', [UserLottaryController::class, 'tickets'])->name('user.lottary.tickets');
    Route::get('/my-lottaries/ticket/{ticket_number}', [UserLottaryController::class, 'viewTicket'])->name('user.lottary.ticket.view');
    Route::get('/my-lottery-wins-ticket',[UserLottaryController::class, 'ViewMyLotteriesWin'])->name('user.lottary.wins.ticket');
    Route::get('/my-lottery-wins',[UserLottaryController::class, 'getMyLotteryWins'])->name('user.lottary.my.wins');
    Route::post('/lottery/winner/{winnerId}/claim',[UserLottaryController::class, 'claimLotteryPrize'])->name('user.lottary.claim');
    Route::post('/lottery/winner/claim', [UserLottaryController::class, 'SingleClaimLotteryPrize'])->name('user.lottary.single.claim');

});

Route::get('/lottery/ticket/{ticket_number}', [UserLottaryController::class, 'viewTicketPublic'])->name('lottery.ticket.public');
Route::get('/lottery', [UserLottaryController::class, 'ViewLottery'])->name('lottery.view');
Route::get('/lottery-with-prize', [UserLottaryController::class, 'LotteryWithPrizes'])->name('lottery-with-prize.view');
Route::get('/lottaries/drawn', [UserLottaryController::class, 'allDrawnLotteries'])->name('user.lottary.drawn');
Route::get('/lottery/last-drew/{id}/winners', [UserLottaryController::class, 'getLotteryWinner'])->name('frontend.lottary.winners');
