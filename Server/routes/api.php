...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::prefix('pickup-point')->group(function () {
        Route::controller(PickupPointController::class)->group(function () {
            ...
            Route::get('payout-summary/{id}', 'payout_summary')->middleware('auth:sanctum');
            Route::get('payout-requests/{id}', 'payout_requests')->middleware('auth:sanctum');
            Route::post('payout-info/update', 'update_payout_info')->middleware('auth:sanctum');
            Route::post('payout-request/store', 'store_payout_request')->middleware('auth:sanctum');
        });
    });
...
Route::any('/webhooks/steadfast', [SteadfastWebhookController::class, 'handle']);
