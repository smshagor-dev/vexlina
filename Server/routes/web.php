...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/home/section/new-products', 'load_new_product_section')->name('home.section.new_products');
    ...
    Route::get('/track-my-order', 'trackOrder')->name('orders.track');
...
Route::get('/exchange-rate-sync-to-db', [CurrencyController::class, 'currencyList'])->name('currency.exchange');
