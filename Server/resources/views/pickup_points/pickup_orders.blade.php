...
<div class="card shadow-none rounded-0 border">
    <div class="card-header border-bottom-0">
        <h5 class="mb-0 fs-20 fw-700 text-dark">{{ translate('Picked Up Orders') }}</h5>
    </div>
    <div class="card-body">
        <table class="table aiz-table mb-0">
            <thead class="text-gray fs-12">
                <tr>
                    ...
                    <th>{{ translate('Mark As On The Way') }}</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input onchange="updatePickupStatus(this, 'on_the_way')" value="{{ $order->id }}" type="checkbox">
        ...
        <div class="aiz-pagination mt-2">{{ $pickup_orders->appends(request()->input())->links() }}</div>
    </div>
</div>
@endsection
