    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Lottery -->
                @canany(['view_lottary', 'add_lottary'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                    <path fill="#575b6a" d="M12 2a10 10 0 1 0 10 10A10.011 10.011 0 0 0 12 2Zm1 17.93V20h-2v-.07A8.001 8.001 0 0 1 4.07 13H4v-2h.07A8.001 8.001 0 0 1 11 4.07V4h2v.07A8.001 8.001 0 0 1 19.93 11H20v2h-.07A8.001 8.001 0 0 1 13 19.93Z"/>
                                </svg>
                            </div>
                            <span class="aiz-side-nav-text">{{ translate('Lottery') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('add_lottary')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('admin.lottary.create') }}">
                                        <span class="aiz-side-nav-text">{{ translate('Create Lottery') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('view_lottary')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('admin.lottary.index') }}">
                                        <span class="aiz-side-nav-text">{{ translate('Lottery List') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('view_lottary')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('admin.lottary.claim.request') }}">
                                        <span class="aiz-side-nav-text">{{ translate('Claim Prize') }}</span>
                                    </a>
                                </li>
                            @endcan
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @endcan
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('steadfast.index')}}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['steadfast.index', 'steadfast.edit', 'steadfast.update']) }}">
                                        <span class="aiz-side-nav-text">{{translate('SteadFast Configuration')}}</span>
                                    </a>
                                </li>
