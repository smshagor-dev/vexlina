	...
	<div>
		...
		<div style=" padding: 0 4rem;">
			<div style="border-bottom: 1px solid rgb(138, 138, 138); padding: 2rem 0 1rem 0">
					...
					<tr>
						<td>
							@if($logo != null)
								...
								<img src="{{ static_asset('assets/img/ll.jpg') }}" height="30" style="display:inline-block;">
							@else
				...
				<table>
					<tr>
						<td style="font-size: 1rem;" class="strong">{{ get_setting('site_name') }} - {{ get_setting('site_motto') }}</td>
					...
					<tr>
						...
						<td class="gry-color small">{{ translate('Email') }}: order@vexlina.com</td>
