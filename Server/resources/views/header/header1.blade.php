    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col">
                <ul class="list-inline d-flex flex-wrap justify-content-between justify-content-lg-start mb-0 top-left-menu">
                    <!-- Language switcher -->
                    ...
                    @if (get_setting('show_currency_switcher') == 'on')
                        ...
                        {{-- Track Order --}}
                        <li class="list-inline-item ml-3 track-order-visibility">
                            <a href="{{ route('orders.track') }}"
                                class="fs-12 py-2 d-flex align-items-center top-text-color-visibility"
    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="d-lg-none ml-auto mr-0" style="display: flex; align-items: center;">
                    
                    @auth
                        @if(Auth::check() && auth()->user()->user_type == 'customer')
                            <!-- Compare for Mobile (Logged in users) -->
                            <div class="d-inline-block" id="compare-mobile" style="margin-right: 14px; ">
                                @include('frontend.partials.compare')
                            </div>
                            <!-- Wishlist for Mobile (Logged in users) -->
                            <div class="d-inline-block" id="wishlist-mobile" style="margin-right: 8px;">
                    ...
                    <div class="aiz-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            @if (isCustomer())
                                ...
                                <li class="user-top-nav-element border border-top-0" data-id="2">
                                    <a href="{{ route('user.lottary.index') }}"
                                        class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                        
                                        <!-- Lottery Icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
                                            <path d="M3 7h18M3 12h18M3 17h18" stroke="#b5b5bf" stroke-width="2" stroke-linecap="round"/>
                                            <circle cx="7" cy="7" r="1.5" fill="#b5b5bf"/>
                                            <circle cx="12" cy="12" r="1.5" fill="#b5b5bf"/>
                                            <circle cx="17" cy="17" r="1.5" fill="#b5b5bf"/>
                                        </svg>
                                
                                        <span class="user-top-menu-name has-transition ml-3">
                                            {{ translate('My Lottaries') }}
                                        </span>
                                    </a>
                                </li>
