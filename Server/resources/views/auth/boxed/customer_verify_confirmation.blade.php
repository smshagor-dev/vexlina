...
<div class="aiz-main-wrapper d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh; background: linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%), url('https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80'); background-size: cover; background-position: center; background-attachment: fixed; padding: 20px;">
    <div class="container">
       <div style="display: -ms-flexbox; display: flex;-ms-flex-wrap: wrap; flex-wrap: wrap; justify-content: center; align-items: center; margin-right: -40px; margin-left: -40px;">
            <!-- Right Side - Customer Verification Code Form -->
            <div class="col-lg-5">
                <div class="water-color-card p-4 p-lg-5" style="
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <!-- Titles -->
                            <h1 class="fs-20 fs-md-24 fw-700 mb-2" style="
                            ...
                            <form id="reg-form" class="form-default" role="form" action="{{ route('customer-reg.verify_code_confirmation') }}" method="POST">
                                ...
                                @if($customerVerification->email != null)
                                    <div class="form-group">
                                        ...
                                        <div class="water-color-input" style="
                                            ...
                                            ">
                                            <input type="text" name="email" class="form-control" value="{{ $customerVerification->email }}" readonly style="
                                                    border: none;
                                ...
                                @else
                                    <div class="form-group">
                                        ...
                                        <div class="water-color-input" style="
                                                ...
                                                transition: all 0.3s ease;
                                            ">
                                            <input type="text" name="phone" class="form-control" value="{{ $customerVerification->phone }}" readonly style="
                                                    border: none;
                                                    background: transparent;
                                                    padding: 14px 20px;
                                                ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="water-color-input" style="
                                            ...
                                            transition: all 0.3s ease;
                                        ">
                                        <input type="number" name="verification_code" class="form-control" value="" style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <!-- Submit Button -->
                                <div class="mb-4 mt-4">
                                    <button type="submit" class="btn btn-primary btn-block fw-600 fs-14" style="
                                            background: linear-gradient(45deg, #e62e04, #ff9900);
                                            border: none;
                                            border-radius: 12px;
                                            padding: 15px;
                                            ...
                                            overflow: hidden;
                                        ">
                                        <span style="position: relative; z-index: 2;">{{ translate('Submit') }}</span>
