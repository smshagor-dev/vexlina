                            ...
                            <form class="form-default" id="forgot-pass-form" role="form" action="{{ route('password.email') }}" method="POST">
                                    ...
                                    <div class="form-group email-form-group mb-3 d-none">
                                        ...
                                        <div class="water-color-input" style="
                                            ...
                                            <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" 
                                                value="{{ old('email') }}" placeholder="{{ translate('johndoe@example.com') }}" name="email" id="email" autocomplete="off" style="
                                                    border: none;
                                                    background: transparent;
                                                    padding: 14px 20px;
                                                ">
                                ...
                                <div class="mb-4">
                                    <button type="submit" class="btn btn-primary btn-block fw-700 fs-14" style="
                                            ...
                                            overflow: hidden;
                                        ">
                                        <span style="position: relative; z-index: 2;">{{ translate('Send Password Reset Code') }}</span>
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const submitBtn = document.querySelector('#forgot-pass-form button[type="submit"]');
            if (submitBtn) {
