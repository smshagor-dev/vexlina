                ...
                <div class="water-color-card p-4 p-lg-5" style="
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-4">{{ translate('Enter your new password and confirm it')}}</p>
                        </div>
                        ...
                        <div class="pt-2">
                            <form class="form-default" role="form" action="{{ route('password.update') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="water-color-input" style="
                                        ...
                                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" 
                                            name="email" value="{{ $email ?? old('email') }}" @if(!empty($email ?? null)) readonly @endif 
                                            placeholder="{{ translate('Email Address') }}" required autofocus style="
                                                border: none;
                                ...
                                <!-- Code -->
                                <div class="form-group mb-3">
                                    <label for="code" class="fs-12 fw-700 text-dark mb-2">{{ translate('Verification Code') }}</label>
                                    <div class="water-color-input" style="
                                            background: rgba(255, 255, 255, 0.9);
                                            border-radius: 12px;
                                            border: 1px solid rgba(230, 46, 4, 0.3);
                                        ...
                                        <input id="code" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" 
                                            name="code" value="{{old('code') }}" placeholder="{{translate('Enter verification code')}}" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <!-- Password -->
                                <div class="form-group mb-3">
                                    <label for="password" class="fs-12 fw-700 text-dark mb-2">{{ translate('New Password') }}</label>
                                    <div class="water-color-input position-relative" style="
                                        ...
                                        <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" 
                                            name="password" placeholder="{{ translate('Enter new password') }}" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <div class="form-group mb-4">
                                    <label for="password-confirm" class="fs-12 fw-700 text-dark mb-2">{{ translate('Confirm Password') }}</label>
                                    <div class="water-color-input position-relative" style="
                                            background: rgba(255, 255, 255, 0.9);
                                            border-radius: 12px;
                                            border: 1px solid rgba(230, 46, 4, 0.3);
                                        ...
                                        <input id="password-confirm" type="password" class="form-control" 
                                            name="password_confirmation" placeholder="{{ translate('Confirm new password') }}" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                        <i class="password-toggle las la-eye position-absolute" style="
                                                ...
                                                color: #666;
                                                font-size: 1.2rem;
                                            " onclick="togglePassword('password-confirm')"></i>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    <button type="submit" class="btn btn-primary btn-block fw-700 fs-14" style="
                                            ...
                                            overflow: hidden;
                                        ">
                                        <span style="position: relative; z-index: 2;">{{ translate('Reset Password') }}</span>
