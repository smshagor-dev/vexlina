...
<div class="aiz-main-wrapper d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh; background: linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%), url('https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80'); background-size: cover; background-position: center; background-attachment: fixed; padding: 20px;">
    <div class="container">
        <div style="display: -ms-flexbox; display: flex;-ms-flex-wrap: wrap; flex-wrap: wrap; justify-content: center; align-items: center; margin-right: -40px; margin-left: -40px;">
            <!-- Right Side - Seller Verification Code Form -->
            <div class="col-lg-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h1 class="fs-24 fw-800 mb-2" style="
                                    ...
                                    letter-spacing: 1px;
                                ">
                                {{ !$isOtpSystemActivated ? translate('Verify Code') : translate('Verify Code') }}
                            </h1>
                            <p class="text-muted mb-4">{{ translate('Enter the verification code sent to you') }}</p>
                        </div>
                            ...
                            <form id="reg-form" class="form-default" role="form" action="{{ route('shop-reg.verify_code_confirmation') }}" method="POST">
                                ...
                                @if($sellerVerification->email != null)
                                    <div class="form-group mb-3">
                                        <label class="fs-12 fw-700 text-dark mb-2">{{ translate('Email') }}</label>
                                        <div class="water-color-input" style="
                                            ...
                                            ">
                                            <input type="text" name="email" class="form-control" value="{{ $sellerVerification->email }}" readonly style="
                                                    border: none;
                                ...
                                @else
                                    <div class="form-group mb-3">
                                        <label class="fs-12 fw-700 text-dark mb-2">{{ translate('Phone') }}</label>
                                        <div class="water-color-input" style="
                                                background: rgba(255, 255, 255, 0.9);
                                                border-radius: 12px;
                                                border: 1px solid rgba(230, 46, 4, 0.3);
                                                ...
                                                transition: all 0.3s ease;
                                            ">
                                            <input type="text" name="phone" class="form-control" value="{{ $sellerVerification->phone }}" readonly style="
                                                    border: none;
                                                    background: transparent;
                                                    padding: 14px 20px;
                                                    color: #666;
                                ...
                                <div class="form-group mb-4">
                                    <label class="fs-12 fw-700 text-dark mb-2">{{ translate('Verification Code') }}</label>
                                    <div class="water-color-input" style="
                                            background: rgba(255, 255, 255, 0.9);
                                            border-radius: 12px;
                                            border: 1px solid rgba(230, 46, 4, 0.3);
                                        ...
                                        <input type="number" name="verification_code" class="form-control" 
                                            placeholder="{{ translate('Enter 6-digit code') }}" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                    </div>
                                    <small class="text-muted mt-2 d-block">{{ translate('Check your email or phone for the verification code') }}</small>
                                </div>
                                ...
                                <div class="mb-4">
                                    <button type="submit" class="btn btn-primary btn-block fw-700 fs-14" style="
                                            ...
                                            overflow: hidden;
                                        ">
                                        <span style="position: relative; z-index: 2;">{{ translate('Verify Code') }}</span>
