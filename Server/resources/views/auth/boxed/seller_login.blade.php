                ...
                <div class="water-color-card p-4 p-lg-5" style="
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-4">{{ translate('Login to your seller account')}}</p>
                        </div>
                        ...
                        <div class="pt-2">
                            ...
                            <div class="text-center pt-3 border-top" style="border-color: rgba(0,0,0,0.1) !important;">
                                <p class="fs-12 text-gray mb-0">
                                    ...
                                    <a href="{{ route(get_setting('seller_registration_verify') === '1' ? 'shop-reg.verification' : 'shops.create') }}" class="ml-2 fs-14 fw-700" style="
                                            background: linear-gradient(45deg, #e62e04, #ff9900);
                                            -webkit-background-clip: text;
...
@section('script')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const registerLink = document.querySelector('a[href="{{ route(get_setting("seller_registration_verify") === "1" ? "shop-reg.verification" : "shops.create") }}"]');
            if (registerLink) {
