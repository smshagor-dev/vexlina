...
<div class="aiz-main-wrapper d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh; background: linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%), url('https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80'); background-size: cover; background-position: center; background-attachment: fixed; padding: 20px;">
    <div class="container">
        <div style="display: -ms-flexbox; display: flex;-ms-flex-wrap: wrap; flex-wrap: wrap; justify-content: center; align-items: center; margin-right: -40px; margin-left: -40px;">
            <!-- Right Side - Shop Registration Form -->
            <div class="col-lg-5">
                <div class="water-color-card p-4 p-lg-5" style="
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-4">{{ translate('Complete your shop registration details')}}</p>
                        </div>
                        ...
                        <div class="pt-2">
                            <form id="reg-form" class="form-default" role="form" action="{{ route('shops.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <div class="water-color-section-header" style="
                                            background: rgba(230, 46, 4, 0.1);
                                            border-radius: 8px;
                                            padding: 10px 15px;
                                            border-left: 4px solid #e62e04;
                                        ">
                                        <div class="fs-14 fw-600" style="color: #e62e04;">{{ translate('Personal Info')}}</div>
                                    </div>
                                </div>

                                <!-- Name -->
                                <div class="form-group mb-3">
                                    <label for="name" class="fs-12 fw-700 text-dark mb-2">{{ translate('Your Name') }}</label>
                                    <div class="water-color-input" style="
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" 
                                            value="{{ old('name') }}" placeholder="{{ translate('Full Name') }}" name="name" required style="
                                                border: none;
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="water-color-input" style="
                                        ...
                                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" 
                                            value="{{ $email ?? old('email') }}" placeholder="{{ translate('Email Address') }}" 
                                            name="email" required {{$email ? 'readonly' : ''}} style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="water-color-input" style="
                                        ...
                                        <input type="tel" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" 
                                            value="{{ $phone ?? old('phone') }}" placeholder="{{ translate('Phone Number') }}" 
                                            name="phone" required {{$phone ? 'readonly' : ''}} style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="water-color-input position-relative" style="
                                        ...
                                        <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" 
                                            placeholder="{{ translate('Create Password') }}" name="password" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="water-color-input position-relative" style="
                                        ...
                                        <input type="password" class="form-control" 
                                            placeholder="{{ translate('Confirm Password') }}" name="password_confirmation" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <div class="mb-3">
                                    <div class="water-color-section-header" style="
                                            ...
                                            border-left: 4px solid #e62e04;
                                        ">
                                        <div class="fs-14 fw-600" style="color: #e62e04;">{{ translate('Shop Info')}}</div>
                                    </div>
                                </div>

                                <!-- Shop Name -->
                                <div class="form-group mb-3">
                                    <label for="shop_name" class="fs-12 fw-700 text-dark mb-2">{{ translate('Shop Name') }}</label>
                                    <div class="water-color-input" style="
                                            background: rgba(255, 255, 255, 0.9);
                                            border-radius: 12px;
                                            border: 1px solid rgba(230, 46, 4, 0.3);
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('shop_name') ? ' is-invalid' : '' }}" 
                                            value="{{ old('shop_name') }}" placeholder="{{ translate('Shop Name') }}" name="shop_name" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <!-- Address -->
                                <div class="form-group mb-4">
                                    <label for="address" class="fs-12 fw-700 text-dark mb-2">{{ translate('Address') }}</label>
                                    <div class="water-color-input" style="
                                            background: rgba(255, 255, 255, 0.9);
                                            border-radius: 12px;
                                            border: 1px solid rgba(230, 46, 4, 0.3);
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" 
                                            value="{{ old('address') }}" placeholder="{{ translate('Full Address') }}" name="address" required style="
                                                border: none;
                                                background: transparent;
                                                padding: 14px 20px;
                                            ">
                                ...
                                <div class="mb-4">
                                    <button type="submit" class="btn btn-primary btn-block fw-700 fs-14" style="
                                            ...
                                            overflow: hidden;
                                        ">
                                        <span style="position: relative; z-index: 2;">{{ translate('Register Your Shop') }}</span>
