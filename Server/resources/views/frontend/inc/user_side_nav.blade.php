    ...
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b5b5bf" viewBox="0 0 16 16">
                            <path d="M2 2h12v2H2V2zm0 4h12v2H2V6zm0 4h12v2H2v-2z"/>
                        </svg>
                
                        <span class="aiz-side-nav-text ml-3">{{ translate('My Lottery') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('user.lottary.index') }}"
                               class="aiz-side-nav-link {{ areActiveRoutes(['user.lottary.index']) }}">
                                <span class="aiz-side-nav-text">
                                    {{ translate('My Lotteries') }}
                                </span>
                            </a>
                        </li>
                        ...
                        <!-- My Win Lotteries -->
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('user.lottary.wins.ticket') }}"
                               class="aiz-side-nav-link {{ areActiveRoutes(['user.lottary.wins.ticket']) }}">
                                <span class="aiz-side-nav-text">
                                    {{ translate('My Win Lotteries') }}
                                </span>
                            </a>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('user.lottary.drawn') }}"
                               class="aiz-side-nav-link {{ areActiveRoutes(['user.lottary.drawn']) }}">
                                <span class="aiz-side-nav-text">
                                    {{ translate('Drawn Lotteries') }}
                                </span>
                            </a>
                        </li>
