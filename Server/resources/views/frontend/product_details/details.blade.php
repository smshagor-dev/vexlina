                ...
                <div class="border-dashed border-1 border-soft-light rounded-2 overflow-hidden mt-4 mb-1 px-20px pt-15px pb-20px">
                    ...
                    <div class="d-flex flex-wrap flex-md-nowrap align-items-center">
                        <button type="button" @if (Auth::check() || get_Setting('guest_checkout_activation')==1) onclick="buyNow()" @else onclick="showLoginModal()" @endif
                            class="text-white border-0 rounded-1 fs-14 fw-bold bg-black hov-opacity-70 has-transition py-20px px-20px d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2">{{ translate('Buy Now') }}</button>
                        <button type="button" id="added_to_cart_btn" @if (Auth::check() || get_Setting('guest_checkout_activation')==1) onclick="addToCart()" @else onclick="showLoginModal()" @endif
                            class="text-blue border-0 rounded-1 fs-14 fw-bold bg-soft-blue hov-bg-blue hov-text-white py-20px px-20px d-block w-100">{{translate('Add to Cart')}} <span id="add_to_cart_count">(01)</span></button>
                    </div>
                    <!--Buttons End-->
                </div>
            @endif
            ...
            <div class="row no-gutters mb-3">
                <div class="col-12 col-sm-12 mt-3">
                    <div class="product-quantity d-flex align-items-center">
                        <a type="button" class="text-white text-center border-0 rounded-1 fs-14 fw-bold bg-black hov-opacity-70 has-transition py-20px px-20px d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2" href="{{ $detailedProduct->external_link }}">
