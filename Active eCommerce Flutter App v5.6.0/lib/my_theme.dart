...
class MyTheme {
  ...
  static const Color accent_color = Color(0xffFA3E00);
  ...
  static Color splash_screen_color = Color(0xffFA3E00);
  ...
  static Color golden_shadow = Color(0xffFA3E00).withValues(alpha: .15);
