...
final SharedValue<int?> system_currency = SharedValue(
  key: "system_currency",
  value: 0, // disk storage key for shared_preferences
);
...
final SharedValue<bool> gst_addon_installed = SharedValue(
  value: false, // initial value
  key: "gst_addon_installed", // disk storage key for shared_preferences
);
...
final SharedValue<bool> recaptcha_customer_login = SharedValue(
  value: false, // initial value
  key: "recaptcha_customer_login", // disk storage key for shared_preferences
);

final SharedValue<bool> recaptcha_customer_register = SharedValue(
  value: false, // initial value
  key: "recaptcha_customer_register", // disk storage key for shared_preferences
);
final SharedValue<bool> recaptcha_forgot_password = SharedValue(
  value: false, // initial value
  key: "recaptcha_forgot_password", // disk storage key for shared_preferences
);
