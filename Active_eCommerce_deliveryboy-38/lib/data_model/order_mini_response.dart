...
class Order {
  ...
  static bool _isValidCoordinate(double? value, {required bool isLatitude}) {
  ...
  bool get hasCustomerLocation =>
      ...
      _isValidCoordinate(lang, isLatitude: false);

  bool get hasStoreLocation =>
      _isValidCoordinate(delivery_pickup_latitude, isLatitude: true) &&
      _isValidCoordinate(delivery_pickup_longitude, isLatitude: false);

  bool get hasAnyDirectionLocation =>
      location_available == true || hasCustomerLocation || hasStoreLocation;

  double? get preferredDirectionLatitude => hasCustomerLocation
      ? lat
      : hasStoreLocation
          ? delivery_pickup_latitude
          : null;

  double? get preferredDirectionLongitude => hasCustomerLocation
      ? lang
      : hasStoreLocation
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
    ...
    store_location_available: json["store_location_available"],
