...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  Future<void> _openCustomerChat() async {
    ...
    final response = await ChatRepository().openCustomerConversation(
    ...
    if (response.result == true && response.conversationId != null) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => DeliveryChat(
            conversationId: response.conversationId!,
            messengerName: response.shopName ?? 'Customer',
            messengerTitle: response.title,
      ...
      ToastComponent.showDialog(
        response.message ?? 'Unable to open customer chat',
        context,
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    elevation: 0,
                                    side: BorderSide(
                                      color: MyTheme.red.withValues(alpha: .25),
                                    ),
                                    shape: RoundedRectangleBorder(
