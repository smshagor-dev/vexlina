                          ...
                          children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if ((order.pickup_point?.address ?? "").isNotEmpty)
                                      Padding(
                                    ...
                                    if ((order.pickup_point?.phone ?? "").isNotEmpty)
                                      Padding(
                                        padding: const EdgeInsets.only(top: 2),
                                        child: Text(
                                          "Phone: ${order.pickup_point!.phone!}",
                                          style: TextStyle(
                                            color: MyTheme.grey_153,
                                            fontSize: 12,
                                          ),
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: (order.return_due == true)
                                      ? MyTheme.red.withValues(alpha: .1)
                                      : MyTheme.soft_accent_color_2.withValues(alpha: .3),
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Text(
                                  order.return_due == true
                                      ? "Return Due"
                                      : "Pickup window: ${order.pickup_window_days_left ?? 0} day(s) left",
                                  style: TextStyle(
                                    color: order.return_due == true
                                        ? MyTheme.red
