...
class _OnTheWayDeliveryState extends State<OnTheWayDelivery> {
  ...
  Future<void> onScanQrAndComplete(dynamic order) async {
    final scannedCode = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const DeliveryQrScanner(),
      ),
    );
    ...
    final deliveryStatusChangeResponse =
    ...
    ToastComponent.showDialog(
      deliveryStatusChangeResponse.message!,
      context,
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        onScanQrAndComplete(_list[index]);
                      },
                    ),
                  ),
                ),
