import 'package:active_flutter_delivery_app/custom/box_decorations.dart';
import 'package:active_flutter_delivery_app/custom/useful_elements.dart';
...
import 'package:active_flutter_delivery_app/repositories/language_repository.dart';
...
class _ChangeLanguageState extends State<ChangeLanguage> {
  ...
  onLanguageItemTap(index) {
    if (index != _selected_index) {
      ...
      Provider.of<LanguagePresenter>(context,listen: false).setLocale(app_mobile_language.$!);
