...
CommissionHistoryResponse commissionHistoryResponseFromJson(String str) =>
    CommissionHistoryResponse.fromJson(json.decode(str));

String commissionHistoryResponseToJson(CommissionHistoryResponse data) =>
...
class CommissionHistoryResponse {
  ...
  factory CommissionHistoryResponse.fromJson(Map<String, dynamic> json) =>
      CommissionHistoryResponse(
        data: List<Commission>.from(
            json["data"].map((x) => Commission.fromJson(x))),
