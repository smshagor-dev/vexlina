...
RefundOrderResponse refundOrderResponseFromJson(String str) =>
    RefundOrderResponse.fromJson(json.decode(str));

String refundOrderResponseToJson(RefundOrderResponse data) =>
...
class RefundOrderResponse {
  ...
  factory RefundOrderResponse.fromJson(Map<String, dynamic> json) =>
      RefundOrderResponse(
