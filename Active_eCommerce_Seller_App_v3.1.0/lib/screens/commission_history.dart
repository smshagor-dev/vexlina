...
class _CommissionHistoryState extends State<CommissionHistory> {
  ...
  Container commissionItem(int index, String orderCode, String adminCommission,
      String date, String sellerEarning) {
                ...
                children: [
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        Text(
                          "${LangText(context: context).getLocal()!.admin_commission_ucf} : $adminCommission",
                          style: TextStyle(
                            fontSize: 12,
                            color: MyTheme.app_accent_color,
                          ),
