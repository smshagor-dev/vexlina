              ...
              child: Column(
                children: [
                  (index == _messages.length - 1) ||
                          _messages[index].year != _messages[index + 1].year ||
                          _messages[index].month != _messages[index + 1].month
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          ...
          bottomLeft: _messages[index].sendType == "seller"
              ? Radius.circular(16)
              : Radius.circular(0),
          bottomRight: _messages[index].sendType == "seller"
              ? Radius.circular(0)
              : Radius.circular(16),
        ),
    ...
    return Shimmer.fromColors(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              width: 1,
              color: index.isOdd ? MyTheme.app_accent_color : MyTheme.grey_153),
          borderRadius: BorderRadius.only(
            topLeft: Radius.circular(16),
            topRight: Radius.circular(16),
