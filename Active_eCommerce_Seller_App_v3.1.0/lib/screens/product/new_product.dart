        ...
        children: [
              ...
              Container(
                ...
                child: Buttons(
                  onPressed: () async {
                    ...
                    _statAndEndTime =
                        "${intl.DateFormat('MM/d/y').format(dateTimeRange!.start)} - ${intl.DateFormat('MM/d/y').format(dateTimeRange!.end)}";
                    setChange();
                  },
          ...
          Row(
            children: [
              ...
              Spacer(),
               Transform.scale(
          scale: 0.8, // Scale horizontally to 90% of its original width (slightly smaller)
          child: Switch(
    ...
    children: [
      ...
      SizedBox(
        ...
        child: Transform.scale(
          scale: 0.8,  // Scale the switch to 80% of its original size
          child: Switch(
            value: value,
            onChanged: onChanged,
            activeColor: MyTheme.green,
