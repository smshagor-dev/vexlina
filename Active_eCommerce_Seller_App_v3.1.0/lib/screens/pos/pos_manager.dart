...
// category
  ...
  return TextField(
    controller: _countryController, // Uses the controller from TypeAheadField
    focusNode: focusNode,
    onTap: () {},
    onSubmitted: (txt) {},
    decoration: buildAddressInputDecoration(
...
builder: (context, controller, focusNode) {
  return TextField(
    controller: _stateController, // Uses the controller from TypeAheadField
    focusNode: focusNode,
    onTap: () {},
    onSubmitted: (txt) {},
    decoration: buildAddressInputDecoration(
      context,
      getLocal(context).enter_state_ucf,
    ),
  );
},
        ...
        buildCommonSingleField(
          ...
          buildCommonTypeAheadDecoration(
           ...
           builder: (context, controller, focusNode) {
  return TextField(
    controller: _cityController, // Replaces _cityController
    focusNode: focusNode,
    onTap: () {},
    onSubmitted: (txt) {}, // Keep blank
    decoration: buildAddressInputDecoration(
      context,
      getLocal(context).enter_city_ucf,
    ),
  );
},
