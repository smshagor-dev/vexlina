          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "${AppLocalizations.of(context)!.verify_your} ${widget.verifyBy == "email" ? AppLocalizations.of(context)!.email_account_ucf : AppLocalizations.of(context)!.phone_number_ucf}",
                  style: TextStyle(
