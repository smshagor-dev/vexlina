...
import 'package:active_ecommerce_seller_app/repositories/digital_product_repository.dart';
...
import 'package:active_ecommerce_seller_app/screens/digital_product/update_digital_product.dart';
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      LangText(context: context).getLocal().current_package_ucf,
                ...
                Row(
                  children: [
                    Text(
                      LangText(context: context).getLocal().upgrade_package_ucf,
                      style: const TextStyle(
                          fontSize: 12,
                          color: MyTheme.app_accent_color,
                          fontWeight: FontWeight.bold),
