...
class _PackagesState extends State<Packages> {
  ...
  Future<bool> getOnlinePaymentList() async {
    var response = await PaymentRepository()
        .getPaymentResponseList(list: "online", mode: "seller_package");
  ...
  Future<bool> getOfflinePaymentList() async {
    var response = await PaymentRepository()
        .getPaymentResponseList(list: "offline", mode: "seller_package");
  ...
  sendPaymentPage({int? package_id, String? payment_method_key, amount}) {
    switch (payment_method_key) {
      ...
      case "iyzico":
        MyTransaction(context: context).push(IyzicoScreen(
          amount: double.parse(amount.toString()),
          payment_method_key: payment_method_key,
          payment_type: "seller_package_payment",
          package_id: package_id.toString(),
      ...
      case "bkash":
        MyTransaction(context: context).push(BkashScreen(
          amount: double.parse(amount.toString()),
          payment_method_key: payment_method_key,
          payment_type: "seller_package_payment",
          package_id: package_id.toString(),
      ...
      case "nagad":
        MyTransaction(context: context).push(NagadScreen(
          amount: double.parse(amount.toString()),
          payment_method_key: payment_method_key,
          payment_type: "seller_package_payment",
          package_id: package_id.toString(),
      ...
      case "paytm":
        MyTransaction(context: context).push(PaytmScreen(
          amount: double.parse(amount.toString()),
          payment_method_key: payment_method_key,
          payment_type: "seller_package_payment",
          package_id: package_id.toString(),
              ...
              child: SubmitBtn.show(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '$packageDate${LangText(context: context).getLocal()!.days_ucf}',
                        style:
                            TextStyle(fontSize: 10, color: MyTheme.light_grey),
                        textAlign: TextAlign.end,
                      ),
                    ],
                  )),
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "$packageProduct ${LangText(context: context).getLocal()!.product_upload_limit_ucf}",
                    style:
                ...
                actions: [
                  ...
                  SubmitBtn.show(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        sendPaymentPage(
                            payment_method_key: _selectedOnlinePaymentTypeValue!
                                .payment_type_key,
                            amount: amount,
                  ...
                  SubmitBtn.show(
                      ...
                      onTap: () {
                        ...
                        MyTransaction(context: context).push(OfflineScreen(
                          details: _selectedOfflinePaymentTypeValue!.details,
                          offline_payment_id: _selectedOfflinePaymentTypeValue!
                              .offline_payment_id,
                          rechargeAmount: double.parse(amount.toString()),
                          package_id: packageId,
                        ));
                        // sendPaymentPage(
