  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: SizedBox(
          child: faceAllData ? buildBodyContainer() : buildLoadingContainer(),
        ),
      ),
    );
  }
...
/*
  ...
  Widget buildMap() {
    return PlacePicker(
      ...
      onTapBack: () {},
      onPlacePicked: (pik) {
        changeLatLang(pik.geometry!.location.lat.toString(),
            pik.geometry!.location.lng.toString());
      },
