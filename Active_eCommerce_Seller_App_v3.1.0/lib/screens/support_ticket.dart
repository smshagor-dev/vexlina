...
class _SupportTicketState extends State<SupportTicket> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(
              context: context,
              title: LangText(context: context).getLocal().support_tickets_ucf)
          .show(),
  ...
  Widget buildTicketItemContainer(BuildContext context, int index) {
    return AnimatedContainer(
        constraints: BoxConstraints(minHeight: _mailHide[index] ? 150 : 110),
            ...
            Row(
              children: [
                ...
                Row(
                  children: [
                    Text(
                      "${LangText(context: context).getLocal()!.options_ucf} - ",
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.normal,
                          color: MyTheme.font_grey),
    ...
    return InkWell(
      ...
      child: MyWidget().myContainer(
          ...
          child: Column(
            ...
            children: [
              Text(
                LangText(context: context).getLocal().create_a_ticket,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 12,
                    color: MyTheme.app_accent_color),
